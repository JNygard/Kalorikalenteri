...
public class MainWindow extends JFrame{
	...
	protected static JMenu menu3 = new JMenu("Lisää");
	...
	protected static JLabel LdayKcalAVG = new JLabel("Keskimäärin: 0 Kcal/päivä");
	protected static JLabel LdayKcal = new JLabel("Päivä: 0 Kcal.");
